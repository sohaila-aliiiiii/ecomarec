...
let vaildation=Yub.object().shape({
  ...
  return (
    <>
    <div className='bg-register py-10 flex items-center justify-center'>
        <div className='bg-white rounded-md p-4  md:w-1/2 shadow-2xl'>
            <h1 className='text-[#3AAF9F] pb-4 text-center font-bold text-3xl '><i className="fa-solid fa-right-to-bracket px-1"></i>Register Now</h1>
